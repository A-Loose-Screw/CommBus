...
static int _modbus_tcp_build_request_basis(modbus_t *ctx, int function,
                                           ...
                                           uint8_t *req)
{
    modbus_tcp_t *ctx_tcp = static_cast<modbus_tcp_t *>(ctx->backend_data);
...
static int _modbus_tcp_pi_connect(modbus_t *ctx)
{
    ...
    modbus_tcp_pi_t *ctx_tcp_pi = static_cast<modbus_tcp_pi_t *>(ctx->backend_data);
...
int modbus_tcp_listen(modbus_t *ctx, int nb_connection)
{
    ...
    ctx_tcp = static_cast<modbus_tcp_t *>(ctx->backend_data);
...
int modbus_tcp_pi_listen(modbus_t *ctx, int nb_connection)
{
    ...
    ctx_tcp_pi = static_cast<modbus_tcp_pi_t *>(ctx->backend_data);
